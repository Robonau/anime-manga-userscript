...
let sites = [
    {name:'kitsu',Vdef:5,Hdef:5},
    {name:'myanimelist',Vdef:5,Hdef:5},
    {name:'anilist',Vdef:5,Hdef:5},
    {name:'animeplanet',Vdef:5,Hdef:5},
    {name:'mangaupdates',Vdef:5,Hdef:5},
    {name:'isekaiscan',Vdef:6,Hdef:5},
    {name:'mangakomi',Vdef:6,Hdef:5},
    {name:'mangatx',Vdef:6,Hdef:5},
    {name:'zinmanga',Vdef:6,Hdef:5},
    {name:'wuxiaworld',Vdef:6,Hdef:5},
    {name:'manganelo',Vdef:6,Hdef:5},
    {name:'mangakakalot',Vdef:6,Hdef:5},
    {name:'mangafast',Vdef:6,Hdef:5},
    {name:'nyaa',Vdef:6,Hdef:5},
    {name:'livechart',Vdef:7,Hdef:5},
    {name:'animefreak',Vdef:6,Hdef:5},
    {name:'animefever',Vdef:6,Hdef:5},
    {name:'animehub',Vdef:6,Hdef:5},
    {name:'animevibe',Vdef:6,Hdef:5},
    {name:'anidb',Vdef:5,Hdef:5},
    {name:'animepahe',Vdef:6,Hdef:5},
    {name:'animedao',Vdef:6,Hdef:5},
    {name:'gogoanime',Vdef:6,Hdef:5}
    ]
    let endis = {}
    let Vpriority= {}
    let Hpriority= {}
